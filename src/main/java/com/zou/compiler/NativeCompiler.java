...
public class NativeCompiler implements Closeable {
    ...
    private void compileClass(JavaFileObject javaFileObject) throws IOException {
        ...
        try {
            ...
            JavaCompiler.CompilationTask task = compiler.getTask(null, fileManager, collector, null, null, Arrays.asList(javaFileObject));
